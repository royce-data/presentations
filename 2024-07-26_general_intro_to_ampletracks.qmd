...
![The Ampletracks GitHub repository](./images/ampletracks_presentation/ampletracks_github.png){.lightbox fig-align="center" style="width:75%;"}
...
- Graph view relationship visualisation
  - Switch from intrinsic to extrinsic relationships (and back again)

## Sample Tracking

![](./images/ampletracks_presentation/graph_view.gif){.lightbox fig-align="center" style="width:85%;"}
...
::: {layout-ncol=2}
![](./images/ampletracks_presentation/label_2224.png){.lightbox style="border: 5px solid; border-color: #555555; margin-left: 0%;width:70%"}

![](./images/ampletracks_presentation/label_2225.png){.lightbox style="border: 5px solid; border-color: #555555; margin-right: 0%;width:70%"}
:::

## Sample Tracking

![](./images/ampletracks_presentation/labels_printed.jpg){.lightbox style="width:45%;" fig-align="center"}
