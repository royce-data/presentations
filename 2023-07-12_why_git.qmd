...
## However...
:::{.fade-in-then-out}
![](images/why_git_images/latex_paper_commented.png){style="display:block;height:60%;width:60%;margin:0 auto;"}
:::
...
- ***I get to work on one common repository on different systems without having to carry a physical drive with me***
