...
<div class="cell" style="display:block; margin:0 0 0 25%; height:45%; width:45%;">
<div class="cell-output-display">
<div id="when-rmdp">
<div>
<pre class="mermaid" data-label="when-rmdp">
  flowchart TB
    A[Do I have a data managment plan?]
    A --Yes--> B[Am I starting a new experiment?]
    A --No--> C(("Write|Update\n my DMP"))
    B --No--> D[Am I changing where I store my research data?]
    B --Yes--> C
    D --No--> E[Am I changing my processing methods?]
    D --Yes--> C
    E --Yes--> C
    E --No--> F[Is my data retention/preservation policy changing?]
    F --Yes--> C
    F --No--> G((Do nothing))
</pre>
</div>
...
- Who will have reuse rights to it?
